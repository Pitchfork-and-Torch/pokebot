    ...
    <div className={`stage ${fable ? "fable" : ""}`}>
      ...
      <div className="housing">
        ...
        <div className="controls">
          ...
          <div className="ab">
            <button type="button" className={`ab-btn${hot("b")}`} onClick={pressB} aria-label="B, back to encounter" {...tip("b")}>
              B
            </button>
            <button type="button" className={`ab-btn a${hot("a")}`} onClick={pressA} aria-label="A, primary action" {...tip("a")}>
              A
            </button>
          </div>
        </div>
